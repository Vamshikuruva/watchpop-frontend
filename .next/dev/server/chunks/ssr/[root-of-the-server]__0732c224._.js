...
async function getMovies(params) {
    ...
    if (params?.friends_recommended) {
        search.set("friends_recommended", params.friends_recommended);
    }
...
async function getSongs(params) {
    ...
    if (params?.listened !== undefined) {
        search.set("listened", String(params.listened));
    }
    search.set("limit", String(params?.limit ?? 100));
    const res = await fetch(`/api/songs?${search.toString()}`);
    return res.json();
}
...
function DiscoverPage() {
    ...
    const [existingMovieIds, setExistingMovieIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const [existingSongIds, setExistingSongIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const typeFromUrl = searchParams.get("type");
    const searchQueryFromUrl = searchParams.get("q");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadExisting = async ()=>{
            // 🎬 Movies
            const movies = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMovies"])({
                limit: 100
            });
            const movieIds = new Set(movies.map((m)=>m.external_id));
            setExistingMovieIds(movieIds);
        };
        loadExisting();
    }, []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadExisting = async ()=>{
            const songs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSongs"])({
                limit: 100
            });
            const songIds = new Set(songs.map((s)=>s.external_id).filter(Boolean));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // 🧹 Clear stale UI before searching
        setResults([]);
        setLoading(true);
        setSearchType(resolvedType);
        setQuery(searchQueryFromUrl);
        search(searchQueryFromUrl, resolvedType).finally(()=>{
            setInitialized(true);
            setLoading(false);
        });
    }, [
    ...
    const search = async (q, type)=>{
        if (!q.trim()) return;
        setLoading(true);
        const data = type === "movie" ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["discoverMovies"])(q) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["discoverSongs"])(q);
        setResults(data);
        setLoading(false);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (searchQueryFromUrl) {
            setQuery(searchQueryFromUrl); // optional but nice UX
            search(searchQueryFromUrl, searchType);
        }
    }, [
        searchQueryFromUrl
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Clear previous search state when switching type
        setResults([]);
        setQuery("");
        setActiveItem(null);
    }, [
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Discover movies and music for your WatchPop"
                        }, void 0, false, {
                            fileName: "[project]/app/discover/page.tsx",
                            lineNumber: 116,
                            columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: ()=>search(query, searchType),
                            style: {
                                padding: "10px 18px",
                                borderRadius: 10,
                                background: "#1976d2",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: !initialized || loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        style: {
                            opacity: 0.6
                        },
                        children: [
                        ...
                        children: [
                            searchType === "movie" && results.map((movie, index)=>{
                                const isAdded = existingMovieIds.has(movie.external_id);
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    style: {
                                                        ...
                                                        padding: "8px 14px",
                                                        borderRadius: 8,
                                                        background: isAdded ? "#333" : "#1976d2",
                                                        color: "white",
                                                        border: "none",
                                                        cursor: isAdded ? "not-allowed" : "pointer",
                                                        fontWeight: 600
                                                    },
                                                    children: isAdded ? "Added ✓" : "Add to WatchPop"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/discover/page.tsx",
                                                    lineNumber: 255,
                                                    columnNumber: 25
                                ...
                                }, `${movie.external_id}-${index}`, true, {
                                    fileName: "[project]/app/discover/page.tsx",
                                    lineNumber: 226,
                                    columnNumber: 21
                                }, this);
                            }),
                            searchType === "music" && results.map((song, index)=>{
                                const isAdded = existingSongIds.has(song.external_id);
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    style: {
                                        display: "flex",
                                        gap: 16,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        onClick: async ()=>{
                                            setSaving(true);
                                            const friendTags = friendInput.split(",").map((t)=>t.trim()).filter(Boolean); // ✅ ensures string[]
                                            if (searchType === "movie") {
                                                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addMovie"])(activeItem.external_id, friendTags);
                                                setExistingMovieIds((prev)=>new Set(prev).add(activeItem.external_id));
                                                setMessage(data.message);
                                                setTimeout(()=>setMessage(null), 3000);
                                            }
                                            if (searchType === "music") {
                                                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addSong"])(activeItem.external_id, friendTags);
                                                setExistingSongIds((prev)=>new Set(prev).add(activeItem.external_id));
                                                setMessage(data.message);
                                                setTimeout(()=>setMessage(null), 3000);
                                            }
                                            setSaving(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0732c224._.js.map