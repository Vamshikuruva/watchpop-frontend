...
async function addSong(song_id, friends_recommended) {
...
async function updateSong(track_id, payload) {
    return fetch(`${API}/songs/${track_id}`, {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json"
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec6eb0a1._.js.map