...
"[project]/lib/discoverMappers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$discoverMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/discoverMappers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AddToWatchpopButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/AddToWatchpopButton.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DiscoverPage() {
    ...
    const [existingMediaIds, setExistingMediaIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    /* ---------- Load existing library items ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            ...
            async function loadExisting() {
                try {
                    ...
                    setExistingMediaIds(new Set([
                        ...movies.map({
                            "DiscoverPage.useEffect.loadExisting": (m)=>m.imdb_id
                        }["DiscoverPage.useEffect.loadExisting"]),
                        ...songs.map({
                            "DiscoverPage.useEffect.loadExisting": (s)=>s.track_id
                        }["DiscoverPage.useEffect.loadExisting"])
                    ]));
                } catch (err) {
    ...
    /* ---------- URL-driven search ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DiscoverPage.useEffect": ()=>{
            ...
            setLoading(true);
            const run = {
                "DiscoverPage.useEffect.run": async ()=>{
                    const data = resolvedType === "movie" ? (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["discoverMovies"])(q)).map(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$discoverMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["discoverMovieToItem"]) : (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["discoverSongs"])(q)).map(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$discoverMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["discoverSongToItem"]);
                    setResults(data);
                    setLoading(false);
                }
            }["DiscoverPage.useEffect.run"];
            run();
        }
    }["DiscoverPage.useEffect"], [
        searchQueryFromUrl,
    ...
    /* ---------- Reset on type switch ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DiscoverPage.useEffect": ()=>{
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AddToWatchpopButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            item: item,
                                            type: searchType,
                                            isAdded: isAdded,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    onClick: async ()=>{
                                        ...
                                        const friends = friendInput.split(",").map((f)=>f.trim()).filter(Boolean);
                                        if (searchType === "movie") {
                                            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addMovie"])(activeItem.id, friends);
                                            setExistingMediaIds((prev)=>new Set(prev).add(activeItem.id));
                                            setMessage(res.message);
                                        } else {
                                            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addSong"])(activeItem.id, friends);
                                            setExistingMediaIds((prev)=>new Set(prev).add(activeItem.id));
                                            setMessage(res.message);
                                        }
                                        setSaving(false);
...
_s(DiscoverPage, "9iPsOvfrGvm/nY9Z09x1rdp8gMk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_b4bdfb99._.js.map